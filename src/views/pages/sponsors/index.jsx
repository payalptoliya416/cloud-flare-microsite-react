                             ...
                             <div className="col-4">
                                 <div className="sponsor-col">
                                    ...
                                    <div className="sponsor-col-data">
                                      ...
                                      <a href="/app/sponsors/sumo-logic"><button className="gradiant-button btn"> View Details<i className="bi bi-chevron-right"></i></button></a>
                                    </div>
                                 </div>
                             </div>
                             <div className="col-4">
                                 <div className="sponsor-col">
                                    ...
                                    <div className="sponsor-col-data">
                                      ...
                                      <a href="/app/sponsors/westcon"><button className="gradiant-button btn"> View Details<i className="bi bi-chevron-right"></i></button></a>
                                    </div>
                                 </div>
                             </div>
                             {/* <div className="col-4">
