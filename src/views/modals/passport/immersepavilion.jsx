...
function ImmersePavilionModal({show , handleClose}) {
    ...
    <>
      <Modal show={show} id="checkbox1" className='passport-modal' dialogClassName='modal-dialog-centered check-modal' onHide={()=>handleClose(false)}>
        ...
        <div className="checkbox-pop">
            ...
            <img src="/assets/image/ImmersePavilionModal.png" alt="" className="black-img"/>
            <div className="checkbox-info">
                <h3>Immerse Pavilion</h3>
...
export default ImmersePavilionModal;