...
function Abstract3Modal({show , handleClose}) {
  ...
  return (
   <Modal show={show} id="popup-three" className='agenda-model' onHide={()=>handleClose(false)}>
      ...
      <Modal.Body>
      <div className="title">
                        <p>In this panel discussion, we will examine the evolution of
                        <strong>AI and cybersecurity</strong>
                        as dual forces—one driving innovation, the other
                        ...
                        <p className="mt-3">This session will explore the interplay between AI and
                          ...
                          adoption</strong>  . Our experts will discuss how organizations can leverage
                          AI to enhance security while mitigating its risks, shaping a secure
                          and adaptive future for enterprises and governmasents alike.</p>
                      ...
                      workloads</p>
                            ...
                            <p className="mt-3"> <strong>AI-Powered Threats & Mitigation Strategies :</strong>
                         Addressing the cybersecurity implications of AI, from adversarial machine learning
                        to deepfake attacks.</p>

                            <p className="mt-3"><strong>Future-Proofing Digital Infrastructure</strong>
                            : Building resilient,
                            quantum-ready, and AI-augmented security frameworks to support
                            national digital initiatives.</p>
                              
                            <p className="mt-3"><strong>AI Governance and Security Framework :</strong>
                            ...
                            <p className="mt-3">Join us for this thought-provoking discussion on how
                                ...
                                security, and network modernization in Thailand and beyond</p>
                    </div>               
      </Modal.Body>
    </Modal>
  );
